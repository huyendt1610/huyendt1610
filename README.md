...
ML Engineer focused on building end-to-end AI systems — from training pipelines
...
📌 Featured: [`mlops-with-github-and-azureml`](https://github.com/huyendt1610/mlops-with-github-and-azureml)
— Production MLOps pipeline on Azure with full CI/CD, IaC, and monitoring
